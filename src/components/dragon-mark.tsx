    ...
    <svg className={className} viewBox="0 0 128 128" role="img" aria-label="Dragon mark">
      <defs>
        <linearGradient id="dragon-mark-gradient" x1="12" y1="10" x2="112" y2="120">
          ...
          <stop offset="0.48" stopColor="#ff6a2b" />
          <stop offset="1" stopColor="#35dfcb" />
        </linearGradient>
      </defs>
      <path
      ...
      />
      <path fill="#07090d" d="M42 70c5-14 39-14 45 0 5 13-4 29-23 29S37 83 42 70Z" />
      <path
        stroke="#f7f3ee"
        strokeLinecap="round"
        strokeWidth="6"
        d="M52 67c4-6 11-6 15 0M75 67c4-6 11-6 15 0"
      />
      <path fill="#ff8a8a" d="M64 78c-5 12 11 12 7 0h-7Z" />
    </svg>
  );
}
